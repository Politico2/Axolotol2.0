...
client.login("OTQxNDQxMDE2MTk0NTM5NTIy.YgV_RQ.yZpdw7PnMPjWtqPs_Mcd5mAbXqw")
...
client.on("messageCreate", (message) => {
    ...
    if(message.content == "dep!server") {
        message.channel.send("__**Ecco il server Axolotol Network!**__: https://discord.gg/qnEqaUfftW")
    }
})
client.on('ready', () => {
